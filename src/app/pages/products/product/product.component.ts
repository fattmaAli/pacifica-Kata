...
export class ProductComponent implements OnInit{
  ...
  updateQuantity(operationType){
    switch (operationType){
      case (OperationType.ADD): this.form.controls.quantity.setValue(this.form.controls.quantity.value + 1 ); break;
      case (OperationType.REMOVE): this.form.controls.quantity.setValue(this.form.controls.quantity.value - 1 ); break;
      default: break;
    }
  }
}
